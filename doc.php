    ...
    <nav class="navbar navbar-inverse" role="navigation">
      ...
      <div id="main-nav" class="collapse navbar-collapse">
        <ul class="nav navbar-nav" id="mainNav">
          ...
          <li><a href="patienthome.php" class="scroll-link">PATIENT MODE</a></li>
...
?> 
  ...
  <div class="panel-body"><BUTTON class="btn button" style="font-size: 20px;color:white"><a href="http://localhost/C_XAMPP_HTDOCS_ashu/ashu/showap.php">VIEW APPOINTMENTS</a></BUTTON></div>
</div>
